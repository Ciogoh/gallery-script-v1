...
function setup() {
  ...
  // 5. INFO BOX (SHORTCUTS) - MODIFICATO QUI
  let shortcutBox = createDiv();
  shortcutBox.parent(sidebar);
  shortcutBox.style('background-color', '#FFFFFF'); // Sfondo bianco per risaltare
  shortcutBox.style('border', '1px solid #ddd');
  shortcutBox.style('border-radius', '8px'); // Angoli arrotondati
  shortcutBox.style('padding', '15px');
  shortcutBox.style('box-shadow', '0 2px 5px rgba(0,0,0,0.05)'); // Leggera ombra

  // Contenuto HTML della box
  shortcutBox.html(`
